        ...
        <div class="card">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="carKm" name="carKm" min="0" max="5000" value="150" step="10">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="flights" name="flights" min="0" max="100" value="2">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="publicTransportKm" name="publicTransportKm" min="0" max="2000" value="50" step="5">
                </div>
                <div class="form-group"></div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="electricity" name="electricity" min="0" max="5000" value="300" step="10">
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="gas" name="gas" min="0" max="2000" value="30" step="1">
                </div>
                <div class="form-group">
